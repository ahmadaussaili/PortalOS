// Modified from https://github.com/anonymousthing/audio-visualizer
/**
 * Vis
 * @argument {*} canvasElement
 * @argument {*} audioElement
 */
function vis(canvasElement, audioElement) {
    //Note: bins needs to be a power of 2
    let displayBins = 256;
    let backgroundColour = "";
    let barColour = "#00cc99";
    ...
    initializeVisualizer(canvasElement, audioElement)
}